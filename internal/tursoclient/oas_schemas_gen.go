...
func (*BaseGroup) transferGroupRes() {}
...
func (o OptBaseGroup) IsSet() bool { return o.Set }
...
// Or returns value if set, or given parameter if does not.
func (o OptBaseGroup) Or(d BaseGroup) BaseGroup {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
...
// GetGroup returns the value of Group.
func (s *RemoveLocationFromGroupOK) GetGroup() OptBaseGroup {
	return s.Group
}
