...
// encodeFields encodes fields.
func (s *BaseGroup) encodeFields(e *jx.Encoder) {
	{
		if s.Name.Set {
			e.FieldStart("name")
			s.Name.Encode(e)
...
var jsonFieldsNameOfBaseGroup = [6]string{
	0: "name",
	1: "version",
	2: "uuid",
	3: "locations",
...
func (s *BaseGroup) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode BaseGroup to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode BaseGroup")
	}
...
func (o *OptBaseGroup) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptBaseGroup to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
