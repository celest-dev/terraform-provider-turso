	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"group": schema.StringAttribute{
				...
				MarkdownDescription: "Filter databases by group name.",
			},
			"schema": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "The schema database name that can be used to get databases that belong to that parent schema.",
				MarkdownDescription: "The schema database name that can be used to get databases that belong to that parent schema.",
			},
		},
	}
}
...
func (v DatabasesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	case attr.ValueStateKnown:
		...
		val, err = v.DatabasesType.ToTerraformValue(ctx)
...
func (v DatabasesValue) Equal(o attr.Value) bool {
	...
	if !v.DatabasesType.Equal(other.DatabasesType) {
		return false
	}
